...
cp -r mlops/models/segment-anything ~/.hermes/skills/mlops/models/segment-anything/

# Option B: Install directly from this repository's raw SKILL.md URL
<agent-cli> skills install https://raw.githubusercontent.com/iizcm/segment-anything-skill/main/SKILL.md

# Option C: Clone this entire repo into your skills directory
git clone https://github.com/iizcm/segment-anything-skill.git ~/.hermes/skills/mlops/models/segment-anything/
```
...
```text
skill_view(name="mlops/models/segment-anything")
```
...
```text
Use the segment anything skill to <describe your specific task here>
```
...
```text
Gunakan skill segment anything untuk <deskripsikan tugas spesifik Anda di sini>
```
